...
#use Symfony\Component\HttpFoundation\Response; // for constants
...
class PickupController
{
    ...
    public function store(PickupStoreRequest $request)
    {
        ...
        $waste = $this->wasteService->makeWaste($data);  // electronic, organic, etc.
        $created = $this->wasteRepo->create($waste);
